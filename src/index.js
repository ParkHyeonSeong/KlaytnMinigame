...
const App = {
  ...
  receiveKlay: function () {
    ...
    agContract.methods.transfer(cav.utils.toPeb("0.1","KLAY")).send({
      ...
      if (receipt.status) {
        spinner.stop();
        alert("0.1 KLAY가 지급되었습니다!");
        $('#transaction').html("");
        $('#transaction').append(`<p><a href = 'https://baobab.scope.klaytn.com/tx/${receipt.transactionHash}' target='_blank'>트랜젝션확인</a></p>`);
